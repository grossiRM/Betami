      MODULE GWFGHBMODULE
        ...
        INTEGER,SAVE,POINTER  ::NPGHB,IGHBPB,NNPGHB,MXPB                !WSCHMID ADDED MXPB
      ...
      TYPE GWFGHBTYPE
        ...
        INTEGER,POINTER  ::NPGHB,IGHBPB,NNPGHB,MXPB                     !WSCHMID ADDED MXPB
...
C     ------------------------------------------------------------------
     ...
     1                       IGHBPB,NNPGHB,GHBAUX,BNDS,MXPB
C
      CHARACTER*200 LINE
C     ------------------------------------------------------------------
      ALLOCATE(NBOUND,MXBND,NGHBVL,IGHBCB,IPRGHB)
      ALLOCATE(NPGHB,IGHBPB,NNPGHB,MXPB)
C
...
C
        ...
        DEALLOCATE(GHBAUX)
        DEALLOCATE(BNDS)
        DEALLOCATE(MXPB)                                                !WSCHMID ADDED MXPB
C
      RETURN
      END
...
C
        ...
        MXPB=>GWFGHBDAT(IGRID)%MXPB                                     !WSCHMID ADDED MXPB
C
      RETURN
      END
...
C
        ...
        GWFGHBDAT(IGRID)%MXPB=>MXPB                                     !WSCHMID ADDED MXPB
C
      RETURN
      END
