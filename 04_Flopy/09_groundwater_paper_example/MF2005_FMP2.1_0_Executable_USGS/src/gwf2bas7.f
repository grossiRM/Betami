      MODULE GLOBAL
        ...
        INTEGER, SAVE, POINTER    ::IFREFM,NODES,IOUT
      ...
      TYPE GLOBALTYPE
        ...
        INTEGER,POINTER    :: IFREFM,NODES,IOUT
...
C  this file to use the IMPLICIT NONE statement.
        PARAMETER (MXPAR=999,MXCLST=2000000,MXINST=50000)
...
C     ------------------------------------------------------------------
     ...
     4                     HOLD,IBOUND,CR,CC,CV,HCOF,RHS,BUFF,STRT,DDREF
...
C1------grids to be defined.
      ...
      ALLOCATE(IXSEC,INBAS,IFREFM,NODES,IOUT)
...
C6E2B---Get the operator that precedes each operand after the first operand.
     ...
     3             LINE(ISTART:ISTOP).EQ.'/' .OR.
     4             LINE(ISTART:ISTOP).EQ.'^') THEN                       ! exponentiation added as 5th binary operator -- rth
